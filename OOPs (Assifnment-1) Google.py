...
​
    def avg_load(self):
        ...
        amount_server=len(self.servers)
        if amount_server == 0:
            return 0
        return amount_load/amount_server
​
...
​
#LoadBalance Alert
#[<__main__.Server object at 0x7fd4184d4e80>,<__main__.Server object at 0x7fd4184d47b8>,<__main__.Server object at #0x7fd4184d4978>]
