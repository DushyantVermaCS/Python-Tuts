#Assignment Question 1.-  Scraping Data from HTPL with Beautiful Soup.

''' Welcome Dushyant Verma from Using Python to Access Web Data'''
...
#Actual data: http://py4e-data.dr-chuck.net/comments_704498.html (Sum ends with 61)
...
You need to adjust this code to look for span tags and pull out the text content of the span tag, convert them to integers and add them
...
# Retrieve all of the span  tags and finding numbers from HTML url...
plus=0
tags = soup('span')
for tag in tags:
    for num in tag:
